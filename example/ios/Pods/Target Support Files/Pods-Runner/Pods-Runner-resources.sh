...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AWSKMS/AWSKMS.bundle"
  ...
  install_resource "${PODS_ROOT}/ParticleAuthCore/XCFrameworks/ParticleAuthCore/ParticleAuthCore.bundle"
  install_resource "${PODS_ROOT}/ParticleNetworkBase/XCFrameworks/ParticleNetworkBase/ParticleNetworkBase.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/SkeletonView/SkeletonView.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/SwiftyJSON/SwiftyJSON.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/SwiftyUserDefaults/SwiftyUserDefaults.bundle"
fi
